    ...
    >
        ...
        <div className="flex flex-col gap-8 max-md:gap-2 flex-3 ">
          ...
          <ScrollTextAnimation>
            <p className="body-base text-black max-w-[674px]">
              ...
              feels honest to both the client and the space itself. Our team
              works fluidly with builders and collaborators to ensure each step
              is calm,coordinated, and grounded in intention.
            </p>
          </ScrollTextAnimation>
        </div>
      </div>
      <div className="gap-second-pair mb-[114px]">
        <div className="flex flex-col md:gap-14 gap-2 flex-1">
          <ScrollTextAnimation>
            <p className="body-base text-black max-w-[674px]">
              Guided by modern simplicity and organic warmth, every design
              evolves into its own identity — shaped by the site’s natural
              rhythm, the aspirations of its owners, and the quiet craftsmanship
